...
uses
  ...
  uiFood.Authentication
    in '..\src\iFood\ParseClasses\uiFood.Authentication.pas',
  ...
  uiFood.Unavailability
    in '..\src\ifood\parseClasses\uiFood.Unavailability.pas',
  ...
  uiFood.MerchantDetail
    in '..\src\ifood\parseClasses\uiFood.MerchantDetail.pas',
  uReturnMessage in '..\src\common\uReturnMessage.pas',
  uiFood.ReplacementOptions
    in '..\src\ifood\parseClasses\uiFood.ReplacementOptions.pas',
  ...
  uiFood.PickupAreaAssigned
    in '..\src\ifood\parseClasses\uiFood.PickupAreaAssigned.pas',
  uiFood.MetaData in '..\src\ifood\parseClasses\uiFood.MetaData.pas',
  uiFood.DeliveryMethod
    in '..\src\ifood\parseClasses\uiFood.DeliveryMethod.pas',
  uiFood.SponsorshipValues
    in '..\src\ifood\parseClasses\uiFood.SponsorshipValues.pas',
  ...
  uiFood.DeliveryAddress
    in '..\src\ifood\parseClasses\uiFood.DeliveryAddress.pas',
