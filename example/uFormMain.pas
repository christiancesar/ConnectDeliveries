...
type
  TFormMain = class(TForm)
    ...
    mOrderDetail: TMemo;
    sbIntegrar: TSpeedButton;
    sbConfirmar: TSpeedButton;
    sbRejeitar: TSpeedButton;
    sbAceitarCancelamento: TSpeedButton;
    sbRejeitarCancelamento: TSpeedButton;
    sbDespachar: TSpeedButton;
    ...
    procedure sbIntegrarClick(Sender: TObject);
  private
    ...
    procedure StatusOrder(AStatus, ACorrelationId: String);
...
procedure TFormMain.StatusOrder(ACorrelationId, AStatus: String);
var
  oIfood: Tifood;
  oReturnMessage: TReturnMessage;
begin
  ...
  try
    oIfood.addHeader('Authorization', 'Bearer ' + FAuth.access_token);
    oReturnMessage := oIfood.StatusOrder(ACorrelationId, AStatus);  
  finally
    FreeAndNil(oIfood);
    FreeAndNil(oReturnMessage);
  end;
end;
...
procedure TFormMain.sbIntegrarClick(Sender: TObject);
begin
  StatusOrder(Integration, lvPolling.Ite);
end;
